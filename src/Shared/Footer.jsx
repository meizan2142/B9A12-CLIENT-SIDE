                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                    ...
                    <div className="col-span-1 sm:col-span-2 lg:col-span-4 space-y-6">
                        ...
                        <div className="flex justify-center lg:justify-start space-x-6 pt-4">
                            <a href="https://github.com/meizan2142" className="text-gray-400 hover:text-[#26AE61] transition-colors" target="blank">
                            ...
                            <a href="https://www.linkedin.com/in/saif-mizan" className="text-gray-400 hover:text-[#26AE61] transition-colors" target="blank">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
